...
def caffeDetect(filename):
    ...
    GrayImage = np.reshape(GrayImage,(GrayImage.shape[0],GrayImage.shape[1],1))    
    ...
    ret = 0.2989*ret[0:200, 0:155,0]+0.5870*ret[0:200, 0:155,1]+0.1140*ret[0:200, 0:155,2];
